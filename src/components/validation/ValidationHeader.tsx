  ...
  return (
    <div className="mb-8 text-center">
      ...
      <p className="text-gray-600 max-w-2xl mx-auto mb-4">
        ...
        com suporte a análise detalhada do código e arquivos mapping.txt do ProGuard.
      </p>
      
      <Alert className="mb-4 bg-blue-50 border-blue-200 text-blue-800">
        <Info className="h-4 w-4 mr-2" />
        <AlertTitle>Análise Comparativa de Código Java</AlertTitle>
        <AlertDescription>
          Faça upload do JAR original, do JAR ofuscado e do arquivo mapping.txt para obter 
          uma análise detalhada das diferenças e correspondências entre as versões.
        </AlertDescription>
      </Alert>
    </div>
  );
